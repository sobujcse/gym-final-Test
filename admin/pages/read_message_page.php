...
<div>
	...
	<div class="row">
			<div class="input-group">
    			...
    			<input type="email" class="form-control input-sm" name="to_email" placeholder="From: info@mail.com" value="<?php if (!empty($from)){echo $from;}?>" readonly>
  			</div>
	</div><br>
	<div class="row">
			Message:<br>
			<textarea class="form-control" rows="5" name="to_message" placeholder="Message" readonly><?php if (!empty($msg)){echo $msg;}?></textarea>
	</div><br>
	<div style="text-align: right;">
