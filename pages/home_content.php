<div class="container">	
	...
	<div id="fh5co-programs-section">
			<div class="container"  id="row_scl1">
				<div class="row">
				...
				<div class="row text-center">
					<div class="col-md-4 col-sm-6">
						<div class="program animate-box">
							...
							<span><a href="#row_scl" class="btn btn-default">Join Now</a></span>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="program animate-box">
...
?>
	...
	<div id="fh5co-pricing-section">
		<div class="container" id="row_scl">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading animate-box">
					<h2>Pricing Plan</h2>
				...
				<div class="pricing">
					<div class="col-md-3 animate-box">
						<div class="price-box">
							...
							<ul class="float" style="list-style: none; text-align: left;">
								<li><a href="#row_scl1">10 Cardio Classes</a></li>
								<li><a href="#row_scl1">5 Swimming Lesson</a></li>
								<li><a href="#row_scl1">5 Yoga Classes</a></li>
								<li><a href="#row_scl1">10 Aerobics</a></li>
								<li><a href="#row_scl1">5 Zumba Classes</a></li>
								<li><a href="#row_scl1">5 Massage</a></li>
								<li><a href="#row_scl1">5 Body Building</a></li>
							</ul>
					...
					<div class="col-md-3 animate-box">
						<div class="price-box">
							...
							<ul class="float" style="list-style: none; text-align: left;">
								<li><a href="#row_scl1">10 Cardio Classes</a></li>
								<li><a href="#row_scl1">10 Swimming Lesson</a></li>
								<li><a href="#row_scl1">8 Yoga Classes</a></li>
								<li><a href="#row_scl1">10 Aerobics</a></li>
								<li><a href="#row_scl1">5 Zumba Classes</a></li>
								<li><a href="#row_scl1">5 Massage</a></li>
								<li><a href="#row_scl1">5 Body Building</a></li>
					...
					<div class="col-md-3 animate-box">
						<div class="price-box popular">
							...
							<p style="text-align: left;" >Our gym includes a huge selection of free weights, resistance stations, machines, and other gear that will help you maximize your potential.</p>
							<ul class="float" style="list-style: none; text-align: left;">
								<li><a href="#row_scl1">15 Cardio Classes</a></li>
								<li><a href="#row_scl1">10 Swimming Lesson</a></li>
								<li><a href="#row_scl1">10 Yoga Classes</a></li>
								<li><a href="#row_scl1">10 Aerobics</a></li>
								<li><a href="#row_scl1">10 Zumba Classes</a></li>
								<li><a href="#row_scl1">5 Massage</a></li>
								<li><a href="#row_scl1">5 Body Building</a></li>
							</ul>
					...
					<div class="col-md-3 animate-box">
						<div class="price-box">
							...
							<ul class="float" style="list-style: none; text-align: left;">
								...
								<li><a href="#row_scl1">10 Swimming Lesson</a></li>
								<li><a href="#row_scl1">10 Yoga Classes</a></li>
								<li><a href="#row_scl1">20 Aerobics</a></li>
								<li><a href="#row_scl1"> 10 Zumba Classes</a></li>
								<li><a href="#row_scl1"> 5 Massage</a></li>
								<li><a href="#row_scl1">10 Body Building</a></li>
							</ul>		
